namespace API_MES.Controllers.v2
{
    ...
    [ApiVersion("2.0")]
    public class A01_Controller : BaseController<help_topic, Ihelp_topicService>
    {
        private readonly Ihelp_topicService _help_topicService;
        private readonly IWebHostEnvironment _WebHostEnvironment;
        public A01_Controller(Ihelp_topicService help_topicService, IWebHostEnvironment WebHostEnvironment) : base(help_topicService, WebHostEnvironment)
        {
