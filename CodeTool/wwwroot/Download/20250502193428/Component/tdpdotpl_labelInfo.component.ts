...
export class tdpdotpl_labelInfoComponent implements OnInit {
  ...
  ngAfterViewInit() {
    this.tdpdotpl_labelService.BaseParameter.ID = Number(this.ActiveRouter.snapshot.params.ID);
  ...
  tdpdotpl_labelSave() {
    ...
    this.tdpdotpl_labelService.SaveAsync().subscribe(
      res => {
        this.tdpdotpl_labelService.FormData = res as tdpdotpl_label;
        this.Router.navigateByUrl(environment.tdpdotpl_labelInfo + this.tdpdotpl_labelService.FormData.PDOTPL_IDX);
  ...
  tdpdotpl_labelAdd() {
    this.Router.navigateByUrl(environment.tdpdotpl_labelInfo + environment.InitializationNumber);
    this.tdpdotpl_labelService.BaseParameter.ID = environment.InitializationNumber;
    this.tdpdotpl_labelSearch();
  }
}
