...
export class tmmtin_dmm_appInfoComponent implements OnInit {
  ...
  ngAfterViewInit() {
    this.tmmtin_dmm_appService.BaseParameter.ID = Number(this.ActiveRouter.snapshot.params.ID);
  ...
  tmmtin_dmm_appSave() {
    ...
    this.tmmtin_dmm_appService.SaveAsync().subscribe(
      res => {
        this.tmmtin_dmm_appService.FormData = res as tmmtin_dmm_app;
        this.Router.navigateByUrl(environment.tmmtin_dmm_appInfo + this.tmmtin_dmm_appService.FormData.TMMTIN_DMM_IDX);
  ...
  tmmtin_dmm_appAdd() {
    this.Router.navigateByUrl(environment.tmmtin_dmm_appInfo + environment.InitializationNumber);
    this.tmmtin_dmm_appService.BaseParameter.ID = environment.InitializationNumber;
    this.tmmtin_dmm_appSearch();
  }
}
