...
import { tdpdmtim_hist } from './tdpdmtim_hist.model';
import { BaseService } from './Base.service';
@Injectable({
    providedIn: 'root'
})
export class tdpdmtim_histService extends BaseService{
 DisplayColumns001: string[] = ['No', 'PDMTIN_IDX', 'VLID_PART_IDX', 'VLID_PART_SNP', 'VLID_GRP', 'VLID_DTM', 'VLID_BARCODE', 'VLID_REMARK', 'TDPDOTPLMU_IDX', 'PDOTPL_IDX', 'TSCOST_IDX', 'BARCD_LOC', 'VLID_DSCN_YN', 'CREATE_DTM', 'CREATE_USER', 'UPDATE_DTM', 'UPDATE_USER', 'Save'];
    ...
    List: tdpdmtim_hist[] | undefined;
    ListFilter: tdpdmtim_hist[] | undefined;
    FormData!: tdpdmtim_hist;
    constructor(public httpClient: HttpClient) {
        super(httpClient);
        this.Controller = "v1/tdpdmtim_hist";
    }
}
