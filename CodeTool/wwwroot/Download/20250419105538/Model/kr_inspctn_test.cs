...
public string? KR_INSPCTN_DATE { get; set; }
public string? KR_INSPCTN_TEXT { get; set; }
public string? KR_INSPCTN_N { get; set; }
public string? KR_INSPCTN_X1 { get; set; }
public string? KR_INSPCTN_X2 { get; set; }
public string? KR_INSPCTN_X3 { get; set; }
public string? KR_INSPCTN_X4 { get; set; }
public string? KR_INSPCTN_X5 { get; set; }
