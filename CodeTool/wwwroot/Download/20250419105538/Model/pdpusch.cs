...
public string? PDP_DATE1 { get; set; }
...
public string? PDP_DATE2 { get; set; }
public string? PDP_COST { get; set; }
public string? PDP_VAT { get; set; }
public string? PDP_ECTCOST { get; set; }
public string? PDP_TOTCOST { get; set; }
...
public string? PDP_BE_COST { get; set; }
public string? PDP_INCO_DT { get; set; }
