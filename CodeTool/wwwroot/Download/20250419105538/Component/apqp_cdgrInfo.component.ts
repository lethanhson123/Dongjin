...
export class apqp_cdgrInfoComponent implements OnInit {
  ...
  ngAfterViewInit() {
    this.apqp_cdgrService.BaseParameter.ID = Number(this.ActiveRouter.snapshot.params.ID);
  ...
  apqp_cdgrSave() {
    ...
    this.apqp_cdgrService.SaveAsync().subscribe(
      res => {
        this.apqp_cdgrService.FormData = res as apqp_cdgr;
        this.Router.navigateByUrl(environment.apqp_cdgrInfo + this.apqp_cdgrService.FormData.CDGR_IDX);
  ...
  apqp_cdgrAdd() {
    this.Router.navigateByUrl(environment.apqp_cdgrInfo + environment.InitializationNumber);
    this.apqp_cdgrService.BaseParameter.ID = environment.InitializationNumber;
    this.apqp_cdgrSearch();
  }
}
