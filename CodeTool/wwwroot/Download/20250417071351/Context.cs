namespace MESContext.Context
{
    ...
    public virtual DbSet<help_category> help_category { get; set; }
public virtual DbSet<help_keyword> help_keyword { get; set; }
public virtual DbSet<help_relation> help_relation { get; set; }
