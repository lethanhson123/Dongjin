...
import { TscodeDetailComponent } from '../tscode-detail/tscode-detail.component';
...
export class TscodeComponent {
  ...
  tscodeSearch() {
    this.tscodeService.Search(this.tscodeSort, this.tscodePaginator);
  }
